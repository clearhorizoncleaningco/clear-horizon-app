...
// `/approve` (e-approval) and `/report` (customer photo report) are public,
// token-gated customer pages (no login).
const PUBLIC_PATHS = ["/login", "/auth/callback", "/auth/signout", "/approve", "/report"];
